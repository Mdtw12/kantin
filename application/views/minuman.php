<div class="container-fluid">
    <h3 class="text-center">Data Minuman</h3>
    <hr>
    <div class="row text-center">
        <?php foreach($minum as $mnm) : ?>
            <div class="card ml-3 mb-4" style="width: 17rem;">
                <img src="<?php echo base_url().'/upload/'.$mnm->gambar?>" class="card-img-top" alt="<?php echo $mnm->nama_makanan ?>">
                <div class="card-body">
...
<!-- Tambahkan ke head atau akhir halaman -->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
<style>
  body {
    font-family: 'Segoe UI', Tahoma, sans-serif;
    background: linear-gradient(to bottom, #ffe0b2, #fff3e0); /* Gradiasi orange ke putih */
    margin: 0;
    padding-bottom: 80px;
  }
